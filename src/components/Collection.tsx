          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            ...
            {hasFilters && (
              <button
                ...
                className="inline-flex items-center justify-center gap-1.5 rounded-full border border-[var(--gold)] bg-background px-4 py-2.5 text-sm font-medium text-[var(--gold-dark)] transition-colors hover:bg-[var(--gold)] hover:text-white"
